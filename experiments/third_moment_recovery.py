...
from utils.gradient_descent_opt import run_nag_third_moment_prior, run_nag_third_moment
...
def parse_args():
    ...
    parser.add_argument('--num_iter', type=int, default=10000, help='Number of iterations')
...
def main():
    ...
    M1_ys, M2_ys, M3_ys = calc_M3_micrographs_wrap(L, sigma2, args.gamma, X_gt, W, args.N, args.num_micro)
    ...
    if args.disable_prior:
        estimate = run_nag_third_moment(X_initial, M1_y, M2_y, M3_y, L, sigma2, args.gamma, lr=args.lr,
                                        momentum=args.momentum, max_iter=args.num_iter)
    else :
        estimate = run_nag_third_moment_prior(X_initial, M1_y, M2_y, M3_y, L, sigma2, args.gamma, lr=args.lr,
                                              momentum=args.momentum, max_iter=args.num_iter)
